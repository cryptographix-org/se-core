        ...
        execute: function () {
            ...
            ByteString = (function () {
                function ByteString(value, encoding) {
                    ...
                    if (!encoding) {
                        if (value instanceof ByteString) this.byteArray = value.byteArray.clone();else if (value instanceof ByteArray) this.byteArray = value.clone();
                    } else {
                        switch (encoding) {
                            case ByteString.HEX:
            ...
            KindBuilder.init(CommandAPDU, 'ISO7816 Command APDU').byteField('CLA', 'Class').byteField('INS', 'Instruction').byteField('P1', 'P1 Param').byteField('P2', 'P2 Param').uint32Field('Lc', 'Command Length', { calculated: true }).field('data', 'Command Data', ByteArray).uint32Field('Le', 'Expected Length').stringField('description', 'Description', {}).stringField('details', 'Details', {});
            ...
            KindBuilder.init(ResponseAPDU, 'ISO7816 Response APDU').uint32Field('SW', 'Status Word').uint32Field('La', 'Actual Length', { calculated: true }).field('data', 'Response Data', ByteArray).stringField('description', 'Description', {}).stringField('details', 'Details', {});
            ...
            JSIMMultosCard = (function () {
                ...
                JSIMMultosCard.prototype.exchangeAPDU = function exchangeAPDU(commandAPDU) {
                    if (commandAPDU.INS == 0xA4) {
                        ...
                        this.selectedApplet = this.applets[0].applet;
                        var fci = new ByteArray([0x6F, 0x00]);
            ...
            primitiveSets = [setZeroPrimitives, setOnePrimitives, setTwoPrimitives, setThreePrimitives];
