...
export class Crypto
{
  ...
  private des( key: Uint8Array, message: Uint8Array, encrypt: number, mode: number, iv?: Uint8Array, padding?: number ): Uint8Array
  {
    //des_createKeys
  ...
  static DES_CBC: Number = 2;
  static DES_ECB = 5;
  static DES_MAC = 8;
  static DES_MAC_EMV = 9;
  static ISO9797_METHOD_1 = 11;
  static ISO9797_METHOD_2 = 12;
